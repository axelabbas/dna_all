...
class arrivedfun extends StatefulWidget {
  const arrivedfun({Key? key}) : super(key: key);

  @override
  State<arrivedfun> createState() => _arrivedfunState();
}

class _arrivedfunState extends State<arrivedfun> {
  @override
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text('Arrived Logs',style: TextStyle(color: Colors.white),),
